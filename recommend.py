...
def prompt_helper(prompt):
    ...
    In category 5 you will identify weather user is asking about some products only so you will return ans having keys category number, product name(key name) return product name with colour and any ocassion name as product name if entered by user\
